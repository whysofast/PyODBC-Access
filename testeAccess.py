...
class FindReferenceTab(QWidget):
    ...
    def InitUI(self):
        ...
        self.RefGroupBox = QGroupBox("Referência")

        self.RefGroupBox_Layout = QHBoxLayout()
        ...
        self.RefGroupBox_Layout.addWidget(self.Reference_LineEdit)
        self.RefGroupBox_Layout.addWidget(self.FoundCircuit_Label)
        self.RefGroupBox_Layout.addWidget(self.FoundCircuit_LineEdit)
        ...
        self.GroupBox_Layout.addWidget(self.UploadMDB_Button)
        self.GroupBox_Layout.addWidget(self.pathMDB_LineEdit)
        self.GroupBox_Layout.addWidget(self.RefGroupBox)
        self.GroupBox_Layout.addWidget(self.Find_Button)
    ...
    def FindReference(self):
        ...
        cursor.execute('select CIRC_ID from CARGA where CODIGO=?',reference)
        ...
        if circuit_id:
            ...
            cursor.execute('select CIRC_ID from BARRA where CODIGO=?',reference)
            circuit_id = cursor.fetchone()
            if circuit_id:
                circuit_id = str(circuit_id).split('(')[1].split(',')[0]
            # print(circuit_id)
